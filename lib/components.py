...
# Things
tSoweli = Thing("soweli", sprite = ["Things/tSoweliBack", "Things/tSoweliSide", "Things/tSoweliFront"], facing = 1, p = False) # animal
...
wKepeken = Word("kepeken", 2, sprite = "Words/wKepeken") # proxy
wDummy = Word(" ", 2)